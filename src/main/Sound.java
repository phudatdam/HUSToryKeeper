...
public class Sound {
    ...
    public Sound(){
        ...
        soundURL[9] = getClass().getResource("/sound/note.wav");
        soundURL[10] = getClass().getResource("/sound/laser.wav");
        soundURL[11] = getClass().getResource("/sound/nỏ.wav");
        soundURL[12] = getClass().getResource("/sound/bùm.wav");
    }
