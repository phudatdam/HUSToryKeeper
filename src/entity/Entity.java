...
public class Entity { // lớp cha cho các lớp khác: nhân vật, NPC, monster, object...
	...
	public void draw(Graphics2D g2) {
        ...
        if (worldX + (32-1)*gp.tileSize > gp.player.worldX - gp.player.screenX - gp.tileSize &&
                worldX - (32-1)*gp.tileSize < gp.player.worldX + gp.player.screenX + gp.tileSize &&
                worldY + (32-1)*gp.tileSize > gp.player.worldY - gp.player.screenY - gp.tileSize &&
                worldY - (32-1)*gp.tileSize < gp.player.worldY + gp.player.screenY + gp.tileSize) {
